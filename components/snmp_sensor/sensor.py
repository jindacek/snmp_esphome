...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_ONLINE): BINARY_SENSOR_SCHEMA,
    }
...
async def to_code(config):
    ...
    # binary
    await add_bin(CONF_ON_BATTERY, var.set_on_battery_binary_sensor)
    await add_bin(CONF_ONLINE, var.set_online_binary_sensor)
